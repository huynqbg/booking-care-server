...
var ClinicService = /*#__PURE__*/function () {
  ...
  _createClass(ClinicService, [{
    key: "createClinic",
    value: function createClinic(data) {
        ...
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                if (!(!data.name || !data.descriptionHTML || !data.descriptionMarkdown || !data.imageBase64 || !data.address)) {
                  _context.next = 5;
                  break;
                }
                resolve({
    ...
    value: function getDetailClinicById(clinicId) {
      return new Promise( /*#__PURE__*/function () {
