      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Huy Nguyen Admin 👻" <huynq2x@gmail.com>',
            // sender address
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return transporter.sendMail({
            ...
            // html body
            attachments: [{
              filename: "prescription-".concat(dataSend.patientId, "-").concat(new Date().getTime(), ".png"),
...
var getBodyHTMLEmail = function getBodyHTMLEmail(dataSend) {
  ...
  if (dataSend.language === 'vi') {
    html = "\n            <h3> Xin ch\xE0o ".concat(dataSend.patientName, "! </h3>\n            <p> B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn Huynq BookingCare </p>\n            <p> Th\xF4ng tin l\u1ECBch kh\xE1m c\u1EE7a b\u1EA1n nh\u01B0 sau: </p>\n            <div><b> Th\u1EDDi gian: ").concat(dataSend.time, " </b></div>\n            <div><b> B\xE1c s\u0129: ").concat(dataSend.doctorName, " </b></div>\n\n            <p> N\u1EBFu c\xE1c th\xF4ng tin tr\xEAn l\xE0 \u0111\xFAng s\u1EF1 th\u1EADt, vui l\xF2ng click v\xE0o \u0111\u01B0\u1EDDng link b\xEAn d\u01B0\u1EDBi \u0111\u1EC3 x\xE1c nh\u1EADn l\u1ECBch kh\xE1m v\xE0 ho\xE0n t\u1EA5t th\u1EE7 t\u1EE5c kh\xE1m b\u1EC7nh </p>\n            <div> <a href=\"").concat(dataSend.redirectLink, "\" target=\"_blank\"> Click v\xE0o \u0111\xE2y \u0111\u1EC3 x\xE1c nh\u1EADn l\u1ECBch kh\xE1m </a> </div>\n            \n            <div> Tr\xE2n tr\u1ECDng c\u1EA3m \u01A1n! </div> \n        ");
  } else if (dataSend.language === 'en') {
    html = "\n            <h3> Dear ".concat(dataSend.patientName, "! </h3>\n            <p> You received this email because you have booked an online appointment on Huynq BookingCare </p>\n            <p> Your appointment information is as follows: </p>\n            <div><b> Time: ").concat(dataSend.time, " </b></div>\n            <div><b> Doctor: ").concat(dataSend.doctorName, " </b></div>\n\n            <p> If the above information is true, please click on the link below to confirm your appointment and complete the examination procedure </p>\n            <div> <a href=\"").concat(dataSend.redirectLink, "\" target=\"_blank\"> Click here to confirm the appointment </a> </div>\n            \n            <div> Thank you! </div> \n        ");
  }
  return html;
};
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var html = '';
  if (dataSend.language === 'vi') {
    html = "\n            <h3> Xin ch\xE0o ".concat(dataSend.patientName, "! </h3>\n            <p> B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn Huynq BookingCare </p>\n            <p> Th\xF4ng tin \u0111\u01A1n thu\u1ED1c c\u1EE7a b\u1EA1n \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m. </p>\n            \n            <div> Tr\xE2n tr\u1ECDng c\u1EA3m \u01A1n! </div> \n        ");
  } else if (dataSend.language === 'en') {
