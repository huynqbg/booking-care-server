...
var PatientService = /*#__PURE__*/function () {
  ...
  _createClass(PatientService, [{
    key: "buildUrlEmail",
    value: function buildUrlEmail(doctorId, token) {
      return "".concat(process.env.URL_CLIENT, "/verify-booking?token=").concat(token, "&doctorId=").concat(doctorId);
    }
  }, {
    key: "postBookAppointment",
    value: function postBookAppointment(data) {
      var _this = this;
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                break;
              case 5:
                token = (0, _uuid.v4)(); // send email: nodemailer
                _context.next = 8;
                return _emailService["default"].sendSimpleEmail({
                  ...
                  redirectLink: _this.buildUrlEmail(data.doctorId, token)
                });
              case 8:
                _context.next = 10;
    ...
    value: function postVerifyBookAppointment(data) {
      return new Promise( /*#__PURE__*/function () {
