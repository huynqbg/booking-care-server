...
var SpecialtyService = /*#__PURE__*/function () {
  ...
  _createClass(SpecialtyService, [{
    ...
    value: function getAllSpecialties() {
      return new Promise( /*#__PURE__*/function () {
    ...
    value: function getDetailSpecialtyById(id, location) {
      return new Promise( /*#__PURE__*/function () {
